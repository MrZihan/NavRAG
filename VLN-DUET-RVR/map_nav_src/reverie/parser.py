...
def postprocess_args(args):
    ...
    args.aug_ft_file = os.path.join(ROOTDIR, 'REVERIE', 'features', ft_file_map[args.features])

    if args.features == 'clip.h14':
        args.mp3d_ft_files = [os.path.join(ROOTDIR, 'REVERIE', 'features', 'clip_vit-h14_mp3d_original.hdf5')]
        args.val_ft_file = os.path.join(ROOTDIR, 'REVERIE', 'features', 'clip_vit-h14_mp3d_original.hdf5')
    elif args.features == 'clip.b16':
        args.mp3d_ft_files = [os.path.join(ROOTDIR, 'REVERIE', 'features', 'clip_vit-b16_mp3d_original.hdf5')]
        args.val_ft_file = os.path.join(ROOTDIR, 'REVERIE', 'features', 'clip_vit-b16_mp3d_original.hdf5')

    if args.env_aug: # only h14
        args.mp3d_ft_files = [
            os.path.join(ROOTDIR, 'REVERIE', 'features', 'clip_vit-h14_mp3d_img_image_synthesis.hdf5'), 
            os.path.join(ROOTDIR, 'REVERIE', 'features', 'clip_vit-h14_mp3d_img_mask_image_synthesis.hdf5'),
            os.path.join(ROOTDIR, 'REVERIE', 'features', 'clip_vit-h14_mp3d_img_style_transfer.hdf5'),
            os.path.join(ROOTDIR, 'REVERIE', 'features', 'clip_vit-h14_mp3d_original.hdf5'),
            ]
    ...
    if args.aug:
        ...
        args.connectivity_dir = os.path.join(ROOTDIR, 'REVERIE', 'connectivity_mp3d')
