    ...
    def rollout(self, train_ml=None, train_rl=False, reset=True):
        ...
        for t in range(self.args.max_action_len):
            ...
            if train_ml is not None:
                # Supervised training
                if self.args.dataset == 'r2r' or self.args.dataset == 'NavRAG':
                ...
                scale_value = 10.
                losses = self.criterion(nav_logits, nav_targets)
                ml_loss += losses[nav_targets!=0].sum() + losses[nav_targets==0].sum() * scale_value
