...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='NavRAG', choices=['NavRAG','r2r', 'r4r'])
    ...
    parser.add_argument('--max_action_len', type=int, default=30)
...
def postprocess_args(args):
    ...
    args.aug_ft_file = os.path.join(ROOTDIR, 'NavRAG', 'features', ft_file_map[args.features])

    if args.features == 'clip.h14':
        args.mp3d_ft_files = [os.path.join(ROOTDIR, 'NavRAG', 'features', 'clip_vit-h14_mp3d_hm3d_gibson.hdf5')]
        args.val_ft_file = os.path.join(ROOTDIR, 'NavRAG', 'features', 'clip_vit-h14_mp3d_hm3d_gibson.hdf5')
    elif args.features == 'clip.b16':
        args.mp3d_ft_files = [os.path.join(ROOTDIR, 'NavRAG', 'features', 'clip_vit-b16_mp3d_hm3d_gibson.hdf5')]
        args.val_ft_file = os.path.join(ROOTDIR, 'NavRAG', 'features', 'clip_vit-b16_mp3d_hm3d_gibson.hdf5')

    #if args.env_aug: # only h14
    #    args.mp3d_ft_files = [
    #        os.path.join(ROOTDIR, 'NavRAG', 'features', 'clip_vit-h14_mp3d_img_image_synthesis.hdf5'), 
    #        os.path.join(ROOTDIR, 'NavRAG', 'features', 'clip_vit-h14_mp3d_img_mask_image_synthesis.hdf5'),
    #        os.path.join(ROOTDIR, 'NavRAG', 'features', 'clip_vit-h14_mp3d_img_style_transfer.hdf5'),
    #        os.path.join(ROOTDIR, 'NavRAG', 'features', 'clip_vit-h14_mp3d_original.hdf5'),
    #        ]



    args.connectivity_dir = os.path.join(ROOTDIR, 'NavRAG', 'connectivity')

    args.scan_data_dir = os.path.join(ROOTDIR, 'Matterport3D', 'v1_unzip_scans')

    args.anno_dir = os.path.join(ROOTDIR, 'NavRAG', 'annotations')
